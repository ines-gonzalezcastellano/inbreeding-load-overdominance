...
rm script_totalv_SD.sh.*

if [ $# -ne 4 ]  
then
	echo "Usage: $0 <PS> <LOD> <sod> <n> " 
	exit 1
fi
...
cp naturalv /state/partition1/armandoPURGA$n/$SLURM_JOBID/
cp purgingv /state/partition1/armandoPURGA$n/$SLURM_JOBID/
